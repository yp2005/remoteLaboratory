...
public class TestTemplateOutput extends TestTemplate {
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    private List<TestExerciseTemplateOutput> testExerciseTemplateList;

    public TestTemplateOutput() {

    }

    public TestTemplateOutput(TestTemplate testTemplate) {
    ...
    public List<TestExerciseTemplateOutput> getTestExerciseTemplateList() {
        return testExerciseTemplateList;
    }

    public void setTestExerciseTemplateList(List<TestExerciseTemplateOutput> testExerciseTemplateList) {
